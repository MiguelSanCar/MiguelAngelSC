...
public class IniPreguntas {
    public static void main(String[] args) {
        ...
        opciones10.add(new Opcion("2", true));
        opciones10.add(new Opcion("4", false));
        opciones10.add(new Opcion("1", false));
        opciones10.add(new Opcion("Ninguna de las anteriores es correcta", false));

        Pregunta pregunta10 = new Pregunta("Cuando se eleva un elemento al cuadrado, ¿a qué número se eleva?", opciones10, "ciencia");

        almacenarDAO.almacenar(pregunta10);

        //opciones pregunta11
        ArrayList<Opcion> opciones11 = new ArrayList<Opcion>();
        opciones11.add(new Opcion("Uniones Interatómicas.", false));
        opciones11.add(new Opcion("Enlace covalentes.", true));
        opciones11.add(new Opcion("Uniones Iónicas", false));
        opciones11.add(new Opcion("Todas las anteriores son correctas", false));

        Pregunta pregunta11 = new Pregunta("Unión química entre dos átomos donde se comparten electrones.", opciones11, "ciencia");

        almacenarDAO.almacenar(pregunta11);
        //opciones pregunta12
        ArrayList<Opcion> opciones12 = new ArrayList<Opcion>();
        opciones12.add(new Opcion("Halógenos.", false));
        opciones12.add(new Opcion("Metales alcalinos.", false));
        opciones12.add(new Opcion("Gases nobles", true));
        opciones12.add(new Opcion("Hierros profundos", false));

        Pregunta pregunta12 = new Pregunta("¿A qué grupo de la tabla periódica pertenece en el helio, el argón y el radón?", opciones12, "ciencia");

        almacenarDAO.almacenar(pregunta12);
